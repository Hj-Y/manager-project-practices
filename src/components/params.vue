<template>
  <div class="goods-params">
    <!-- 面包屑 -->
    <breadcrumb sectitle="商品管理" thirdtitle="分类参数"></breadcrumb>
    <!-- alert提示框 -->
    <el-alert class="params-alert" title="注意:只允许为三级分类设置相关参数" type="warning" show-icon></el-alert>
    <!-- 级联选择器 -->
    ...
    <!-- tab栏 -->
    <el-tabs class="params-tabs" v-model="activeName">
      <el-tab-pane label="动态参数" name="first">
        <el-button class="params-button" type="primary" disabled size="small">动态参数</el-button>
      ...
      <el-tab-pane label="静态参数" name="second">
        <el-button class="params-button" type="primary" disabled size="small">静态参数</el-button>
        <el-table :data="tableData" border style="width: 100%">
          <el-table-column type="index" width="180"></el-table-column>
